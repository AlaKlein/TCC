...
variable "machine_size" { default = "Standard_B2ms" } #Standard_DS3_v2 Standard_B2ms
variable "admin_username" { default = "ala_klein" }
variable "cert_name" { default = "id_rsa" }
variable "network_interface_config_name" { default = "nicConfig" }
variable "os_disk_name" { default = "myOsDisk" }
